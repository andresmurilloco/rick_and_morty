...
import { AlternarMostrar } from '../js/ShowTrigger';
...
const Index = () => {
  const [estadoTexto, setEstadoTexto] = useState('ocultarParrafo');
  const alternar=()=>{
    setEstadoTexto(AlternarMostrar(estadoTexto));
  }
  return (
    <>
      <div className='ml-24 mr-24 mt-5 mb-5 max-[850px]:ml-5 max-[850px]:mr-5'>
        <div className='rounded-md bg-green-400  border-yellow-500 border-4 shadow-md shadow-orange-300 mt-5 p-3'>
          ...
          <button onClick={alternar}>Show more</button>
        </div>
